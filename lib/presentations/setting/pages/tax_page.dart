...
import 'package:flutter_cafe/presentations/setting/dialogs/form_tax_dialog.dart';
import 'package:flutter_cafe/presentations/setting/models/tax_model.dart';
import 'package:flutter_cafe/presentations/setting/widgets/add_data.dart';
import 'package:flutter_cafe/presentations/setting/widgets/manage_tax_card.dart';
...
class _TaxPageState extends State<TaxPage> {
  final List<TaxModel> items = [
    ...
    TaxModel(name: 'Biaya Layanan', type: TaxType.layanan, value: 10),
